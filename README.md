1. GitHub: https://github.com/makle04/CW2024
   ...
   **2. Compilation Instructions**
        ...
        2.2. Download zipfile from Github and extract MakLeJoshua_Intellij_23.zip

        2.3. Open Intellij and only load file CW2024-master into Intellij
   
        2.4. Load Maven when if it is prompted at the bottom right
   
        2.5. Open file Main from file path src/main/java/com.example.demo/Controller/Main.java

        2.6. Once Maven has fully been loaded and Main.java is open in the editor, User can run main to start the game.
